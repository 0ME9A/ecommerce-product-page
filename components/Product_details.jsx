...
function Products_details() {
  ...
  return (
    <article className="w-full md:w-full mt-6 lg:mt-0 lg:w-[445px] text-sm font-bold px-4 lg:p-0">
      <h2 className="tracking-wider uppercase text-orange text-sm">
        Sneaker Company
      </h2>
      <h1
      ...
      <p className="text-sm sm:text-base font-light leading-7 mt-4 lg:mt-9 tracking-[4%] sm:tracking-normal text-grayish-blue">
